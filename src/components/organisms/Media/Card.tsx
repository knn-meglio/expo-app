...
const MediaCard: React.FC<MediaCardProps> = ({ title, description, image }) => {
  ...
  return (
    <ThemedView className="bg-white dark:bg-gray-800 rounded-lg mx-3 overflow-hidden mb-3">
      <Link href="/media/1" asChild>
